...
## Corpus Check
- 241 files · ~139,713 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 871 nodes · 1282 edges · 87 communities (81 shown, 6 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3fce7551`
...
Cohesion: 0.17
Nodes (4): fetchCandidateById(), fetchCandidates(), uploadResume(), handleResumeUpload()
...
Cohesion: 0.4
Nodes (5): updateAssessment(), updateCandidate(), updateCandidateStatus(), updateInterview(), PUT()
...
- **Why does `POST()` connect `Community 16` to `Community 4`, `Community 20`, `Community 21`, `Community 24`, `Community 27`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `handleResumeUpload()` connect `Community 21` to `Community 6`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `uploadResume()` connect `Community 21` to `Community 16`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
